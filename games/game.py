...
try:
    ...
    ctypes.CDLL("/home/alone/.local/lib/python3.12/site-packages/sdl3/bin/libSDL3.so", mode=ctypes.RTLD_GLOBAL)
    ctypes.CDLL("/home/alone/.local/lib/python3.12/site-packages/sdl3/bin/libSDL3_image.so", mode=ctypes.RTLD_GLOBAL)
    ctypes.CDLL("/usr/lib/x86_64-linux-gnu/libSDL2_mixer.so", mode=ctypes.RTLD_GLOBAL)
except OSError as e:
